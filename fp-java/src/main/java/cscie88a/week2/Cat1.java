...
public class Cat1 {
	...
	private static final Logger logger = LoggerFactory.getLogger(Cat1.class);
	...
	public Cat1(String name, String eyeColor, String bodyColor) {
		this.name = name;
	...
	public void whoAmIInstance(){
		logger.info("I am a Cat, of species {}! I am an instance method: " +
						"My name is {}, I have {} eyes and {} body",
	...
	public static void main(String[] args) {
		...
		Cat1 emptyCat = new Cat1();
		// create a new instance of a Cat with initialization of the state
		Cat1 demon = new Cat1("Demon", "green", "black");
		Cat1 sneaky = new Cat1("Sneaky", "blue", "gray");
